...
DROP INDEX IF EXISTS ix_ecobat_occurrence_passes_occurrence_id;
CREATE INDEX ix_ecobat_occurrence_passes_occurrence_id ON ecobat_occurrence_passes(ecobat_occurrence_id);